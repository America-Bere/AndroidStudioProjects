...
public class PreguntaDieciocho extends AppCompatActivity implements View.OnClickListener {
    Button sig,sal;
    CheckBox rp1,rp2,rp3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pregunta_dieciocho);
        sig=(Button) findViewById(R.id.s18);
        sal=(Button)findViewById(R.id.sig18);
        rp1=(CheckBox) findViewById(R.id.rp49);
        rp2=(CheckBox) findViewById(R.id.rp50);
        rp3=(CheckBox) findViewById(R.id.rp51);
    ...
    public void onClick(View v) {
        ...
        if(rp1.isChecked() && rp2.isChecked()){
            ...
            co.setView(bien);
            co.show();
            Intent siguiente=new Intent(this,PreguntaDiecinueve.class);
