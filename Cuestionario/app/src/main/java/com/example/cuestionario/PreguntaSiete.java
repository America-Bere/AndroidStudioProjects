...
public class PreguntaSiete extends AppCompatActivity implements View.OnClickListener{
    Button sig,sal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sig=(Button) findViewById(R.id.s7);
        sal=(Button)findViewById(R.id.sig7);
        rp1=(RadioButton) findViewById(R.id.rp19);
        rp2=(RadioButton) findViewById(R.id.rp20);
        rp3=(RadioButton) findViewById(R.id.rp21);
    ...
    public void onClick(View v) {
        ...
        if(rp2.isChecked()){
            ...
            co.setView(bien);
            co.show();
            Intent siguiente=new Intent(this,PreguntaOcho.class);
